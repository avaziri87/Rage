...
---------------------------------------------------------
| class		  :	ClipBank								|
| description :	This is a helper class used by the		|
...
| description :	Scriptable Object class used to 		|
|				represent Audio Collection assets.  	|
---------------------------------------------------------
*/
...
public class AudioCollection : ScriptableObject
{
    ...
    /*
    ---------------------------------------------------------
    | class		  :	IndexerProperty (Property)  			|
    | description :	Allows us to fetch a random audio clip	|
    ...
    */
    ...
    /*
    ---------------------------------------------------------
    | class		  :	audioClip (Property)					|
    | description :	Returns a random audio clip from the 1st|
    |				clip bank (Bank[0]).                  	|
    ---------------------------------------------------------
    */
